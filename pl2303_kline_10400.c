...
static speed_t pl2303_get_supported_baud_rate(speed_t baud)
{
	static const speed_t baud_sup[] = {
		75, 150, 300, 600, 1200, 1800, 2400, 3600, 4800, 7200, 9600, 10400,
...
MODULE_DESCRIPTION("Prolific PL2303 USB to serial adaptor driver (K-Line 10400)");
MODULE_LICENSE("GPL");
